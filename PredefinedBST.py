...
def create_predefinedbsts_manual():
    ...
    # Tree 3 (Note: intermediate lines for tree 2/3 setup omitted/truncated in between images, 
    # but here are the specific lines shown in image 2 for tree 3 configuration):
...
# print_bst(root3)  # Output: 5 10 15 20 25 30 35 40 50 55 60 ...